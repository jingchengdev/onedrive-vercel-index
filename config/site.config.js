...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@onehydepark.uk',
  ...
  email: 'mailto:admin@onehydepark.uk',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/jingchengdev/onedrive-vercel-index/',
    },
  ],
